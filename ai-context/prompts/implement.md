# Implement Prompt — movie-finder-docs

**Repo:** `aharbii/movie-finder-docs`
**Pre-commit:** ./scripts/prepare-docs.sh && mkdocs build --strict
**Note:** Never commit PNGs. Never generate .mdj files. Only commit .puml source files.
...
You are implementing GitHub issue #[ISSUE_NUMBER] in `aharbii/movie-finder-docs`.

Step 1: Fetch the issue.
gh issue view [ISSUE_NUMBER] --repo aharbii/movie-finder-docs
...
gh pr create --repo aharbii/movie-finder-docs --title "..." --body "..."
...
gh issue comment [N] --repo [REPO] --body "PR aharbii/movie-finder-docs#[PR]: [url]. [what this means for that issue]"
